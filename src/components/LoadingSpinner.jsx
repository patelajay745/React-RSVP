...
export const InlineSpinner = ({ size = 4, className = "" }) => {
  return (
    <svg
      className={`animate-spin -ml-1 mr-2 h-${size} w-${size} ${className}`}
...
// Container loading spinner (for sections/cards)
export const ContainerSpinner = ({ height = "h-40", message }) => {
  return (
    <div
